{\scriptsize%
	\begin{tikzpicture}[shorten >=1pt,scale=0.9]
        ...
        \node[unit](y1) at (12,3.8){$\hat{y}_1^{(L+1)}$};
        \node[unit](y2) at (12,2.0){$\hat{y}_2^{(L+1)}$};
		\node at (12,1.0){\vdots};
        \node[unit](yc) at (12,-0.2){$\hat{y}_C^{(L+1)}$};
		...
		\draw [
            decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt
        ] (11.5,4.5) -- (12.75,4.5) node [black,midway,yshift=+0.6cm]{output layer};
	\end{tikzpicture}
}
