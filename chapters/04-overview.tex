...
Tiefe: Pipeline Steps $\rightarrow$ possible solutions $\rightarrow$ research points (only mention)\\
        Sequence Modeling $\rightarrow$ CNN, RNN, Transformer $\rightarrow$ \ldots
