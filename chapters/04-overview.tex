...
% FIXME: mehr Allgemeinheit zu den Beispielen!
...
Note that the approach is only modeled to recognize horizontal text
instances~\citep{liao_textboxes_2017}.
...
this approach is taken from SSD, the difference is reflected in the prediction
