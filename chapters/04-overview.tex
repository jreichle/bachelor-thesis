...
% FIXME: idea frrom \cite{ponti_everything_2017}
\begin{figure}[ht]
    \centering
    \subfigure[Residual block\label{fig:residual-block}]{%
        \input{figure-code/tikz/resnet-tikz.tex}%
    }
    \subfigure[Residual block with pooling\label{fig:residual-block}]{%
        \input{figure-code/tikz/residual-pooling-tikz.tex}%
    }
    \subfigure[Residual bottleneck block\label{fig:residual-block}]{%
