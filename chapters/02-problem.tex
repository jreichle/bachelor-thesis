...
% FIXME: delete data requirements and highlight other categorization
% FIXME: add that requirements where not gathered according to normal processes (like stakeholder
%           analysis\ldots) -> no systematic way but literature research
...
\end{figure}
% TODO: need source for sentence below?
