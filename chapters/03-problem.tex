...
% FIXME: System figure from nakamichi_requirements
...
\begin{table}[h]\label{tb:LiteratureQualitiesModel}
    ...
    \begin{tabular}{p{.6\textwidth} p{.4\textwidth}}
        ...
        \midrule
        \textit{Resource Utilization} &~\cite{siebert_construction_2021,
...
% Robustness
% FIXME: this is the quality that literature concerning STD and STR refer to
...
% Performance efficiency
% FIXME: more of a quality for infrastrucure -> not in the scope
...
% FIXME: for siebert: execution efficiency in infrastrucure, but can be put to model also and
%               grouped with resource utilization
