...
\begin{figure}[hb]
    ...
    \subfigure[\scriptsize IIIT 5k Word (2012) \citep{mishra_scene_2012}\label{fig:IIIT-5k}]
        {\includegraphics[width=0.25\textwidth]{img/Dataset-Examples/IIIT-5k-word-examples.png}}
    \subfigure[\scriptsize MSRA-TD500 \citep{cong_yao_detecting_2012}\label{fig:msra-td500}]
        {\includegraphics[width=0.25\textwidth]{img/Dataset-Examples/MSRA-TD500-examples.png}}
    \subfigure[\scriptsize Total Text (2017) \citep{chng_total-text_2017}\label{fig:total-text}]
        {\includegraphics[width=0.25\textwidth]{img/Dataset-Examples/Total-Text-examples.png}}
