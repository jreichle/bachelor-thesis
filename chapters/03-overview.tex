...
\begin{table}[h]
    ...
    \begin{tabular}{p{.04\textwidth}p{.11\textwidth}p{.15\textwidth}p{.55\textwidth}}
...
% FIXME: curved label generation? polygon
The following approaches introduced innvations regarding curved \ac{STD}:
...
% XXX: more in depths explanation?
