...
The 1-stage \ac{BB} regresseion approach by~\citep{liao_textboxes_2018} introduced a different
...
The efficient approach from~\cite{lyu_multi-oriented_2018} is pixel level segmentation based.
