...
\begin{table}[h]
    ...
    \begin{tabular}{p{.04\textwidth}p{.115\textwidth}p{.16\textwidth}p{.52\textwidth}}
...
The basis for the segmentation-based methods is that every part of the text instance can
...
The 2-stage approach used as an example was introduced by~\cite{busta_deep_2017}.
...
% FIXME: change lexicon to: what combination of subtask categories
\begin{table}[ht]
    \centering\scriptsize
...
\begin{figure}[ht]
    ...
    ]{\includegraphics[width=0.17\textwidth]{img/STR-2d-attention-Li-Show-2019.png}}
    \subfigure[
...
\begin{table}[h]
    ...
    \begin{tabular}{p{.09\textwidth}p{.19\textwidth}p{0.03\textwidth}p{0.37\textwidth}
            p{0.07\textwidth}p{0.157\textwidth}}
