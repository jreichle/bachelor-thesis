...
% FIXME: when talking about segmentation: not semantic or instance segmentation gemeint
...
\begin{table}[h]
    \centering\scriptsize
    \begin{tabular}{p{.09\textwidth}p{.16\textwidth}p{.20\textwidth}p{.07\textwidth}
...
% FIXME: adjust cutof at 100?
\begin{table}[h]
    \centering\scriptsize
    \begin{tabular}{p{.11\textwidth}p{.16\textwidth}p{.20\textwidth}
            p{0.37\textwidth}p{0.04\textwidth}}
...
\begin{table}[h]
    \centering\scriptsize
    \begin{tabular}{p{.11\textwidth}p{.20\textwidth}p{0.37\textwidth}p{0.04\textwidth}}
...
\end{table}
% FIXME: table that has points on the relevant qualities
