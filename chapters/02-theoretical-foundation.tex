...
% conv layer
% FIXME: convolution operation mostly used with same padding
...
\end{figure}
% FIXME: feature pyramid network
% \cite{lu_mimicdet_2020} FPN [18] proposed a top-down architecture with lateral connection to generate a feature pyramid for multi-scale detection. In our work, instead of detecting object directly, the two-stage detec- tion head performs as a teacher model in mimic mechanism and will not be used for inference.


% FIXME: add upsampling: bilinear interpolation, deconv and reverse pooling

\section{Recurrent Neural Nets}
% FIXME: input often tokenized (like for transformer)~\cite{cho_learning_2014,asadi_encoder-decoder_2020}
% FIXME: add vector-sequence,sequence-vector,sequence-sequence
...
Because of this, \ac{DL} methods are the prefered tools for performing
