...
% FIXME: note probabilistic view (distributions, frequentist/bayesian)
...
% FIXME: emphasize difference: feedforward --- fully conv/fully connected
...
% FIXME: backpropagation/training not really talked about after this, as it exceeds the scope of thesis
...
% FIXME: explain ResNet and VGG-16
...
\end{figure}
% FIXME: check dimensions of variables -> might need to be bold
% FIXME: h as hidden state
% FIXME: unrolling not deep network in the CNN sense
...
% FIXME: update with Michigan Lecture and http://colah.github.io/posts/2015-08-Understanding-LSTMs/
...
% FIXME: gradient clipping for against exploding gradients
...
\end{figure}
% FIXME: update figure according to michigan lecture
% FIXME: explain nodes and concatenation
...
% FIXME: add BiLSTMs?
% FIXME: add vector-sequence,sequence-vector,sequence-sequence(attention)

\section{Transformers}
% FIXME: look into \cite{kloss_learning_2016}
...
\end{figure}
% FIXME: explain encoder/decoder - attention
