...
\end{itemize}
\includegraphics{img/OCR-Pipeline.png}

OCR-phases~\cite{srivastava_comparative_2021}
\includegraphics{img/OCR-Phases.png}
...
From Github~\cite{noauthor_yangxue0827rotationdetection_nodate}
\includegraphics{img/Detection-Modules.png}
