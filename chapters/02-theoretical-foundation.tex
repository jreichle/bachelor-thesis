...
% FIXME: input often tokenized (like for transformer)
...
singular values of those weight matrices are $>1$ or $<1$~\citep{goodfellow_deep_2016}.
...
% FIXME: either improve or remove
