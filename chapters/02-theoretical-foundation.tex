...
% FIXME: explain difference: model - algorithm
...
% FIXME: combine test error and curse of dimensionality with generalization error
The calculation with the test set $\Xt$
Curse of dimensionality

Overfitting --- Underfitting
% FIXME: graphic for underfitting/overfitting
