...
The main challenges for \ac{STD} involve the trade-off between speed and accuracy as well as
...
% FIXME: two stage pooling used for two stage sts
...
\section{Reflection}
% FIXME: Comparing numbers on benchmarks and not looking at quanitative data would result in fallacy.
