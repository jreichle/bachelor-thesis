...
\begin{itemize}
    \item many real world texts appear in arbitrary layouts, quadrangle-based approches nmot well
        adapted
...
\begin{itemize}
    \item Component-free methods: treat every text instance as a complete whole $\rightarrow$ directly
        ...
        as prior knowledge
    \item Component-based methods: model text instances from local perspectives and decompose
        instances into locally detectable segments and links
        $\rightarrow$ combine segments into whole words
\end{itemize}
...
\begin{itemize}
    ...
    \item box is `translated' to 2D-Gaussian $\rightarrow$ KLD with prediction and true gaussian as
        Loss
...
challenge: represent oriented characters and curved text that are distributed over a 2-dimensional
space
...
STR with Sliding Convolutional Character Methods\cite{yin_scene_2017}
